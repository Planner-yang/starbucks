                        ...
                        <section class="join-form submit-box">
                            <div class="wrapper wrapper-mobile">
                                <div class="login-form">
                                    <div class="form-field"><input type="hidden" value="version">
                                        <div class="field floating">
                                            <div class="ok"><input type="text" id="username" name="username"
                                        ...
                                        <div class="password-group-field">
                                            <div class="field floating">
                                                <div class="ok"><input type="password" name="password" placeholder="密码"
                                                                       value=""
                                                                       autocomplete="new-password"><label>密码</label>
                                                </div>
                                            </div>
                                    ...
                                    <div class="field checkbox">
                                        ...
                                        <label for="login-remember"><span>下次自动登录</span></label>
                                    </div>

                                    <p><a id="sign-in-forgot-password"
                                          href="#"
                                          class="link"><span>忘记密码？</span></a>
                                    </p>

                                    <div class="field captcha">
                                        <div class="item captchaWrapper"><!-- react-empty: 71 -->
                                            <div style="width: 300px; height: 160px; margin: 0px auto; position: relative; z-index: 0;">
                                                <iframe frameborder="0" border="0" marginheight="0" marginwidth="0"
                                                        scrolling="no"
                                                        style="width: 300px; height: 152px; border: 0px; position: relative; left: 0px; top: 0px; z-index: 2000000002;"
                                                        <%--src="https://captcha.guard.qcloud.com/cap_union_new_show?
                                                        aid=1253432169&asig=p6WYf3Sqhs9nUXaYtJDWo9tlu7phPtKZXCLED
                                                        y7GfgdKcajBhllOpTXp5oMRBpkdGeGaWRJ46HjFwita-UtARUlPWysXO8rK
                                                        &captype=&protocol=https&clientype=2&disturblevel=&apptype=
                                                        &curenv=open&ua=TW96aWxsYS81LjAgKFdpbmRvd3MgTlQgMTAuMDsgV2l
                                                        uNjQ7IHg2NCkgQXBwbGVXZWJLaXQvNTM3LjM2IChLSFRNTCwgbGlrZSBHZW
                                                        NrbykgQ2hyb21lLzY4LjAuMzQ0MC4xMDYgU2FmYXJpLzUzNy4zNg==&sess
                                                        =4djz_gTN4e4cqk9XBlEaMlOepDYqZCPTx1s8-KymmRvxHqAJaOtvsTRh3d
                                                        aIBntSbAed8jDgVjdv37jwCoUlwdqY1WqmUe6SLKfvr0wm1z0Q4YRnnZxc9
                                                        _o9XGMTM9-iGlTSL83Wmy6qmOkvhUm40eIogyRV6dMtMzX-miQoafwoy-8x
                                                        Lkh7AreU5oGUtO_wo92vkLv1l5c*&theme=&sid=6605165614063420182
                                                        &noBorder=noborder&fb=1&forcestyle=undefined&subsid=2&color
                                                        =00A862&showtype=embed&uid=&cap_cd=&lang=2052&rnd=212809&TC
                                                        apIframeLoadTime=30&prehandleLoadTime=38&createIframeStart=
                                                        1537884961522">--%>
                                    ...
                                    <div class="actions">
                                        <button class="button large" disabled=""><span>登录</span></button>
                                    </div>
                                </div>
                            </div>
                        </section>
