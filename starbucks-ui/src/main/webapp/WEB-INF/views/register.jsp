...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <script type="text/javascript" async="" src="/static/assets/js/analytics.js"></script><script src="/static/assets/js/hm.js"></script><script async="" src="/static/assets/js/gtm.js"></script><script>window.dataLayer = [];</script>
    <!-- Google Tag Manager -->
                    ...
                    <nav data-reactroot="" class="container middle secondary">
                        ...
                        <div class="tabs-wrapper">
                            <ul class="subcategories">
                                ...
                                <li><a class="false"
                                       href="https://www.starbucks.com.cn/account/my-starbucks-rewards"><span>关于星享俱乐部</span></a>
                                </li>
                            </ul>
                        </div>
                    </nav>
            ...
            <div data-reactroot="">
                ...
                <section class="join-form register-form submit-box">
                    <div class="wrapper wrapper-mobile">
                            ...
                            <div>
                                <div>
                                    <div class="field floating">
                                        <div class="ok"><input type="text" id="cardNumber" name="cardNumber"
                                                               pattern="d*" class="card-number" value=""
                                                               placeholder="输入您的星享卡或星礼卡卡号（请勿输入空格或下划线）"
                                                               data-error-isrequired="true"
                                                               data-error-ismsrcardnumber="true"><label>输入您的星享卡或星礼卡卡号（请勿输入空格或下划线）</label>
                                        </div>
                                    </div>
                                    <div class="password-container">
                                        <div class="field floating">
                                            <div class="ok"><input type="text" id="cardPassword" name="cardPassword"
                                                                   pattern="d*" value="" placeholder="输入密码"
                                                                   data-error-isrequired="true"
                                                                   data-error-ismsrcardpinorsvccardpin="true"
                                                                   data-error-issvccardpin="false"
                                                                   data-error-ismsrcardpin="true"><label>输入密码</label>
                                            </div>
                                        </div>
                                        <a id="sign-up-what-is-this" class="link">这是什么？</a></div>
                                    <div class="actions revert">
                                        <button id="sign-up-next" class="button large" disabled="">下一步</button>
                                    </div>
                                </div>
                        ...
                        <a class="register-box box" href="https://www.starbucks.com.cn/apps/" target="_new"><h2><span>还没有卡？</span>
                        </h2>
                            <div class="float-right"><span id="msr-intro-icon-android"><img
                                    src="/static/assets/images/icon-android.svg"></span><span
                                    id="msr-intro-icon-ios"><img src="/static/assets/images/icon-ios.svg"></span></div>
                            <hr class="separator">
                            <span><span>下载 </span><span class="apron-green"><span>星巴克APP</span></span><span> 在线购买电子星礼卡，10 元立减金助力开启星享之旅。</span></span></a>
                    </div>
                </section>
            </div>
        </div>
